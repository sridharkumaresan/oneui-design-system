...
- `Foundation/Gradient System` catalogs every canonical gradient name and demonstrates approved usage on hero surfaces, compact panels, icon backplates, and section/header accents.
...
- Use canonical gradients from `@functions-oneui/theme` instead of authoring raw gradient strings in package stories.
